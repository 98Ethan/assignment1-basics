...
from cs336_basics.transformer.layers import Linear, Embedding, RMSNorm, SwiGLU, RotaryPositionalEmbedding
...
def run_swiglu(
    ...
    # Create SwiGLU layer and load the provided weights
...
def run_multihead_self_attention(
    ...
    # Create the attention module without RoPE
...
def run_multihead_self_attention_with_rope(
    ...
    # Create the attention module with RoPE
    attention = MultiHeadSelfAttention(d_model=d_model, num_heads=num_heads, theta=theta, max_seq_len=max_seq_len)
...
def run_transformer_block(
    ...
    """
    from cs336_basics.transformer.model import TransformerBlock
    
    # Create the transformer block with RoPE
    ...
    # Set the weights manually from the provided state dict
    block.attn_norm.gain.data = weights["ln1.weight"]
    block.ffn_norm.gain.data = weights["ln2.weight"]
...
def run_transformer_lm(
    ...
    for i in range(num_layers):
        ...
        layer.attn_norm.gain.data = weights[f"layers.{i}.ln1.weight"]
        ...
        # FFN normalization
        layer.ffn_norm.gain.data = weights[f"layers.{i}.ln2.weight"]
...
def run_rmsnorm(
    ...
    """
    # Create RMSNorm layer and load the provided weights
...
def run_cross_entropy(inputs: Float[Tensor, " batch_size vocab_size"], targets: Int[Tensor, " batch_size"]) -> Float[Tensor, ""]:
    ...
    # Use the generalized cross_entropy_loss function directly
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.transformer.utils import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.transformer.utils import get_lr_cosine_schedule
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    from cs336_basics.tokenize.train import bpe_tokenizer_word_freq
